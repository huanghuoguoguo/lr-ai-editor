...
LrTasks.startAsyncTask(function()
    ...
    local jsonParts = {
        ...
        '    "Highlights": ', developSetting(currentSettings, "Highlights", "Highlights2012", 0), ',\n',
        '    "Shadows": ', developSetting(currentSettings, "Shadows", "Shadows2012", 0), ',\n',
        '    "Whites": ', developSetting(currentSettings, "Whites", "Whites2012", 0), ',\n',
        '    "Blacks": ', developSetting(currentSettings, "Blacks", "Blacks2012", 0), ',\n',
        '    "Texture": ', developSetting(currentSettings, "Texture", nil, 0), ',\n',
        '    "Clarity": ', developSetting(currentSettings, "Clarity", "Clarity2012", 0), ',\n',
        '    "Dehaze": ', developSetting(currentSettings, "Dehaze", nil, 0), ',\n',
        '    "Vibrance": ', developSetting(currentSettings, "Vibrance", nil, 0), ',\n',
        '    "Saturation": ', developSetting(currentSettings, "Saturation", nil, 0), ',\n',
        '    "Temperature": ', developSetting(currentSettings, "Temperature", nil, 6500), ',\n',
        '    "Tint": ', developSetting(currentSettings, "Tint", nil, 0), ',\n',
        '    "HueAdjustmentRed": ', developSetting(currentSettings, "HueAdjustmentRed", nil, 0), ',\n',
        '    "HueAdjustmentOrange": ', developSetting(currentSettings, "HueAdjustmentOrange", nil, 0), ',\n',
        '    "HueAdjustmentYellow": ', developSetting(currentSettings, "HueAdjustmentYellow", nil, 0), ',\n',
        '    "HueAdjustmentGreen": ', developSetting(currentSettings, "HueAdjustmentGreen", nil, 0), ',\n',
        '    "HueAdjustmentAqua": ', developSetting(currentSettings, "HueAdjustmentAqua", nil, 0), ',\n',
        '    "HueAdjustmentBlue": ', developSetting(currentSettings, "HueAdjustmentBlue", nil, 0), ',\n',
        '    "SaturationAdjustmentRed": ', developSetting(currentSettings, "SaturationAdjustmentRed", nil, 0), ',\n',
        '    "SaturationAdjustmentOrange": ', developSetting(currentSettings, "SaturationAdjustmentOrange", nil, 0), ',\n',
        '    "SaturationAdjustmentYellow": ', developSetting(currentSettings, "SaturationAdjustmentYellow", nil, 0), ',\n',
        '    "SaturationAdjustmentGreen": ', developSetting(currentSettings, "SaturationAdjustmentGreen", nil, 0), ',\n',
        '    "SaturationAdjustmentAqua": ', developSetting(currentSettings, "SaturationAdjustmentAqua", nil, 0), ',\n',
        '    "SaturationAdjustmentBlue": ', developSetting(currentSettings, "SaturationAdjustmentBlue", nil, 0), ',\n',
        '    "LuminanceAdjustmentRed": ', developSetting(currentSettings, "LuminanceAdjustmentRed", nil, 0), ',\n',
        '    "LuminanceAdjustmentOrange": ', developSetting(currentSettings, "LuminanceAdjustmentOrange", nil, 0), ',\n',
        '    "LuminanceAdjustmentYellow": ', developSetting(currentSettings, "LuminanceAdjustmentYellow", nil, 0), ',\n',
        '    "LuminanceAdjustmentGreen": ', developSetting(currentSettings, "LuminanceAdjustmentGreen", nil, 0), ',\n',
        '    "LuminanceAdjustmentAqua": ', developSetting(currentSettings, "LuminanceAdjustmentAqua", nil, 0), ',\n',
        '    "LuminanceAdjustmentBlue": ', developSetting(currentSettings, "LuminanceAdjustmentBlue", nil, 0), ',\n',
        '    "ParametricShadows": ', developSetting(currentSettings, "ParametricShadows", nil, 0), ',\n',
        '    "ParametricDarks": ', developSetting(currentSettings, "ParametricDarks", nil, 0), ',\n',
        '    "ParametricLights": ', developSetting(currentSettings, "ParametricLights", nil, 0), ',\n',
        '    "ParametricHighlights": ', developSetting(currentSettings, "ParametricHighlights", nil, 0), ',\n',
        '    "Sharpness": ', developSetting(currentSettings, "Sharpness", nil, 40), ',\n',
        '    "SharpenRadius": ', developSetting(currentSettings, "SharpenRadius", nil, 1.0), ',\n',
        '    "SharpenDetail": ', developSetting(currentSettings, "SharpenDetail", nil, 25), ',\n',
        '    "SharpenEdgeMasking": ', developSetting(currentSettings, "SharpenEdgeMasking", nil, 0), ',\n',
        '    "LuminanceSmoothing": ', developSetting(currentSettings, "LuminanceSmoothing", nil, 0), ',\n',
        '    "ColorNoiseReduction": ', developSetting(currentSettings, "ColorNoiseReduction", nil, 25), ',\n',
        '    "PostCropVignetteAmount": ', developSetting(currentSettings, "PostCropVignetteAmount", nil, 0), ',\n',
        '    "PostCropVignetteMidpoint": ', developSetting(currentSettings, "PostCropVignetteMidpoint", nil, 50), ',\n',
        '    "PostCropVignetteFeather": ', developSetting(currentSettings, "PostCropVignetteFeather", nil, 50), ',\n',
        '    "GrainAmount": ', developSetting(currentSettings, "GrainAmount", nil, 0), ',\n',
        '    "GrainSize": ', developSetting(currentSettings, "GrainSize", nil, 25), ',\n',
        '    "GrainFrequency": ', developSetting(currentSettings, "GrainFrequency", nil, 50), ',\n',
        '    "SplitToningShadowHue": ', developSetting(currentSettings, "SplitToningShadowHue", nil, 0), ',\n',
        '    "SplitToningShadowSaturation": ', developSetting(currentSettings, "SplitToningShadowSaturation", nil, 0), ',\n',
        '    "SplitToningHighlightHue": ', developSetting(currentSettings, "SplitToningHighlightHue", nil, 0), ',\n',
        '    "SplitToningHighlightSaturation": ', developSetting(currentSettings, "SplitToningHighlightSaturation", nil, 0), ',\n',
        '    "SplitToningBalance": ', developSetting(currentSettings, "SplitToningBalance", nil, 0), ',\n',
        '    "LensProfileEnable": ', developSetting(currentSettings, "LensProfileEnable", nil, 0), ',\n',
        '    "AutoLateralCA": ', developSetting(currentSettings, "AutoLateralCA", nil, 0), ',\n',
        '    "LensManualDistortionAmount": ', developSetting(currentSettings, "LensManualDistortionAmount", nil, 0), ',\n',
        '    "LensVignettingAmount": ', developSetting(currentSettings, "LensVignettingAmount", nil, 0), ',\n',
        '    "LensVignettingMidpoint": ', developSetting(currentSettings, "LensVignettingMidpoint", nil, 50), '\n',
        '  },\n',
        '  "metadata": {\n',
        '    "fileName": "', jsonEscape(metadataValue(photo, "fileName")), '",\n',
        '    "cameraModel": "', jsonEscape(metadataValue(photo, "cameraModel")), '",\n',
        '    "lens": "', jsonEscape(metadataValue(photo, "lens")), '",\n',
        '    "iso": "', jsonEscape(metadataValue(photo, "isoSpeedRating")), '",\n',
        '    "focalLength": "', jsonEscape(metadataValue(photo, "focalLength")), '",\n',
        '    "aperture": "', jsonEscape(metadataValue(photo, "aperture")), '",\n',
        '    "shutterSpeed": "', jsonEscape(metadataValue(photo, "shutterSpeed")), '",\n',
        '    "captureTime": "', jsonEscape(metadataValue(photo, "captureTime")), '"\n',
        '  }\n',
        '}'
    }
    local requestBody = table.concat(jsonParts)
    log("请求JSON已生成")
